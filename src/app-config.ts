...
export const appRoutes: AppRouteConfig[] = [
    ...
    { id: 'popup-demo', path: '/popup-demo', component: lazy(() => import('./pages/PopupPage')), menu: { text: '팝업 호출', group: 'patterns' } },
    { id: 'address-search', path: '/address-search', component: lazy(() => import('./pages/AddressSearchPage')), menu: { text: '우편번호 검색', group: 'patterns' } },
